...
python3 eval.py --test_dir /dataset --scene_name test1_bicubic_noise2 --image_out /output/RRN-5L --num_layers 5
python3 eval.py --test_dir /dataset --scene_name test1_bicubic_noise2 --image_out /output/RRN-10L --num_layers 10
